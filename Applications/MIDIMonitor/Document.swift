...
extension Document {
    ...
    private var badFileTypeError: Error {
        let reason = String(localized: "Unknown file type.", comment: "error reason for unknown file type read or write")
    ...
    private var badFileContentsError: Error {
        let reason = String(localized: "Can't read the contents of the file.", comment: "error reason for unknown file contents")
...
extension Document {
    ...
    private func undoableSetSelectedInputSources(_ newValue: Set<InputStreamSource>) {
        if let undoManager {
            ...
            undoManager.setActionName(String(localized: "Change Selected Sources", comment: "change source undo action"))
        }
    ...
    @objc private func undoableSetMaxMessageCountNumber(_ number: NSNumber) {
        if let undoManager {
            ...
            undoManager.setActionName(String(localized: "Change Remembered Events", comment: "change history limit undo action"))
        }
    ...
    @objc private func undoableSetFilterMaskNumber(_ number: NSNumber) {
        if let undoManager {
            ...
            undoManager.setActionName(String(localized: "Change Filter", comment: "change filter undo action"))
        }
    ...
    @objc private func undoableSetChannelMaskNumber(_ number: NSNumber) {
        if let undoManager {
            ...
            undoManager.setActionName(String(localized: "Change Channel", comment: "change channel undo action"))
        }
